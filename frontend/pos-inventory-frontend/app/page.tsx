...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-radial from-blue-200 to-blue-300 to to-blue-500 flex flex-col items-center justify-center p-6">
      {/* Logo / Brand Section */}
      <div className="mb-12 text-center">
        ...
        <p className="text-gray-300 mt-2">Manage your sales and inventory seamlessly.</p>
      </div>
